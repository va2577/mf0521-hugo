...
このあたりを見て pyenv, Anaconda を避けてきたのですが、
...
[Numba のインストールでバージョンを合わせるのが面倒]({{< relref "70.md" >}})だから、まとめて Anaconda で使える状態にしようと考え始めたので、
...
`-a` のオプションで停止しているコンテナーも表示できるようです。
